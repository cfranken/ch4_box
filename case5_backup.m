...
global k_co_flag use_strat interactive_OH use_other_sinks ignoreCO fitKX% Other
% Plotting flags
...
fitKX = true; % do we fit for other arbitrary reactions?
...
% difference in OH
f = 2.07;
kX_NH = 1.84*ones(nT,1); % 1/seconds
kX_SH = f*ones(nT,1); % 1/seconds
