...
% Components
Sa_ch4     =    100^2*ones(nT,1);
Sa_ch4c13  =    50^2*ones(nT,1);
%Sa_mcf_nh  = max([.2*ems_p(:,5),1.5*ones(nT,1)],[],2).^2;
Sa_mcf_nh  = max([.05*ems_p(:,5),1*ones(nT,1)],[],2).^2;

Sa_mcf_sh  =   1^2*ones(nT,1);
%Sa_mcf_nh  =   eps^2*ones(nT,1);
%Sa_mcf_sh  =   eps^2*ones(nT,1);
Sa_n2o     =   2.0^2*ones(nT,1);
Sa_c2h6    =  5000^2*ones(nT,1);
Sa_oh      =  1500^2*ones(nT,1);
Sa_co      =   2000^2*ones(nT,1);
